...
export default function ImpactOfMarketing() {
  ...
  return (
    <div className="landing-page" id="marketingstrategis">
      <h2 className="title">
        Unleash Revenue Growth with Proven Marketing Strategies
      </h2>
      <p className="description">
        Our data-driven and creative strategies help brands accelerate leads,
        optimize conversions, and expand revenue. Each campaign combines
        insight, innovation, and proven methods to deliver measurable results.
        Clients gain clarity and control over their growth, ensuring lasting
        impact in the competitive digital landscape.
      </p>
          ...
          <div className="features-list">
            {featureData.map((item) => (
              <div key={item.id} className="feature-wrapper">
                ...
                {/* Mobile Content */}
                <div
                  className={`mobile-content ${expandedId === item.id ? "expanded" : ""}`}
                >
                  <Image
                    src={item.img}
                    alt={item.title}
