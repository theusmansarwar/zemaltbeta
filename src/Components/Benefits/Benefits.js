    ...
    <section className="benefits">
      <div className="benefits-left">
        ...
        <p className="benefits-text">
          You deserve respect in your workplace. You also deserve a career that
          helps you grow. At our company, you find more than a job. You step
          into a path that builds skills, offers stability, and supports balance
          in life. The team works together, stands strong, and celebrates every
          success. You gain access to programs that improve your skills and open
          new doors. Each step pushes you closer to your goals and your future.
        </p>
      </div>
